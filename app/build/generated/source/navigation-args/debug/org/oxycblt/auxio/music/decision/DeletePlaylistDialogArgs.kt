...
public data class DeletePlaylistDialogArgs(
  ...
  public companion object {
    ...
    public fun fromBundle(bundle: Bundle): DeletePlaylistDialogArgs {
      bundle.setClassLoader(DeletePlaylistDialogArgs::class.java.classLoader)
      ...
      return DeletePlaylistDialogArgs(__playlistUid)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): DeletePlaylistDialogArgs {
      val __playlistUid : Music.UID?
