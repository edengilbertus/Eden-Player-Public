...
public data class PlayFromArtistDialogArgs(
  ...
  public companion object {
    ...
    public fun fromBundle(bundle: Bundle): PlayFromArtistDialogArgs {
      bundle.setClassLoader(PlayFromArtistDialogArgs::class.java.classLoader)
      ...
      return PlayFromArtistDialogArgs(__songUid)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): PlayFromArtistDialogArgs {
      val __songUid : Music.UID?
